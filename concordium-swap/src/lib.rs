...
#[init(contract = "concordium_swap", event = "Cis2Event<ContractTokenId, ContractTokenAmount>")]
...
/// testing.
#[receive(contract = "concordium_swap", name = "view", return_value = "ViewState")]
